...
description: "# It's time to revisit `vim` Every year or so, I go through my `.vimrc` with a more critical eye, adding and purging configurations that were once us..."
