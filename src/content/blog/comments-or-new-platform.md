...
description: "# I want comments  The one thing that is lacking from this portfolio page, turned blog. A comments section!  Within the `_config.yml` there are a few..."
