...
description: "Now comes the bit part. Many bits and bobs, but will try to capture all the steps required to install Jenkins as well as setup a repo together with t..."
pubDatetime: 2022-03-26T00:00:00Z
tags:
  - CI/CD
---
...
![Github source](/img/jenkins-installed/pipeline_3.png)
...
![adding webhook](/img/jenkins-installed/pipeline_5.png)
...
![github repo settings](/img/jenkins-installed/pipeline_6.png)
...
![Manage Webhooks](/img/jenkins-installed/pipeline_7.png)
...
![credential config](/img/jenkins-installed/pipeline_8.png)

After this credential is created and saved, you should see the new entry, as seen below.

![credential view](/img/jenkins-installed/pipeline_9.png)
